...
function buildUserProfile(likedReviews: any[]): UserProfile {
  ...
  return {
    dimensionVector,
    walkScoreRange,
    rentRange: null, // filled in caller after DB lookups
    crimeTolerance: null, // filled in caller after DB lookups
    preferredStates,
  };
}

function buildNeighborhoodDimensionVector(neighborhood: any): number[] {
